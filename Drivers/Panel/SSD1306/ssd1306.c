...
void ssd1306_Init(void) {
    ...
    ssd1306_WriteCommand(0x80);  //105HZ

	ssd1306_WriteCommand(0xA8);  // Select Multiplex Ratio
	ssd1306_WriteCommand(63);

	ssd1306_WriteCommand(0xAD);  // intrrnal IREF setting
	ssd1306_WriteCommand(0x20);	 //disable  intrrnal IREF

	ssd1306_WriteCommand(0xD3);  //Setting Display Offset
    ssd1306_WriteCommand(0x00);  //00H Reset,  set common start

	ssd1306_WriteCommand(0x40);  //Set Display Start Line

	ssd1306_WriteCommand(0x8D);  // Set Charge Pump
	//ssd1306_WriteCommand(0x10);// Disable Charge Pump
	ssd1306_WriteCommand(0x14);  // Endable Charge Pump


	ssd1306_WriteCommand(0xA1);  //Set Segment Re-Map Default
	...
	ssd1306_WriteCommand(Contrast_volue);

	ssd1306_WriteCommand(0xD9);  // Set Pre-Charge period
    ssd1306_WriteCommand(0x22);

	ssd1306_WriteCommand(0xDB);  // Set Deselect Vcomh level
    ssd1306_WriteCommand(0x00);
...
//        ssd1306_WriteCommand(0x10 + SSD1306_X_OFFSET_UPPER);
        ...
        ssd1306_WriteData(&SSD1306_Buffer[0],sizeof(SSD1306_Buffer));
//    }
}
